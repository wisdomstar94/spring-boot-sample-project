...
public class JwtTokenProvider {
    ...
    private String secretKey = "0dPZw1643640246095jPIAaWRGWBhbQ3O7NvtbaiVjXzWiY4APOin";
    ...
    // JWT 토큰 생성
    public String createToken(String userKey, List<String> roles) {
...
//                .signWith(SignatureAlgorithm.HS256, secretKey)  // 사용할 암호화 알고리즘과
    ...
    public boolean validateToken(String jwtToken) {
        try {
            Jws<Claims> claims = getJws(jwtToken);
